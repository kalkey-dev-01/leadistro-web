    ...
    <>
      <div className="grid place-items-center  ">
        <div className="grid grid-rows-[100px_75px_100px_minmax(300px_1fr)] gap-1 md:grid-cols-[minmax(600px,1fr)_50px]">
          ...
          {/* <div className="h-full w-full bg-white text-leadistroDark">04</div> */}
          {/* <div className="h-full w-full bg-white text-leadistroDark">05</div> */}
          {/* <div className="h-full w-full bg-white text-leadistroDark">06</div> */}
          {/* <div className="h-full w-full bg-white text-leadistroDark">07</div> */}
          {/* <div className="h-full w-full bg-white text-leadistroDark">08</div> */}
        </div>
      </div>
    </>
  );
