    ...
    >
      <div>
        <div
          ...
          className="z-10 mt-16 flex min-h-screen min-w-full flex-col items-center justify-between overflow-x-hidden py-24 md:flex-row  md:px-4 "
        >
          {/* Title && Subtitle */}
          <div className="flex  flex-col items-center justify-center text-white drop-shadow-[0_5px_3px_rgba(0,0,0,0.4)]  md:items-start">
            ...
            <h6 className="my-10  text-base font-normal lg:text-xl xl:text-2xl ">
              {' '}
              Unlock the full potential of your campaigns with our powerful
              market researcher app
            </h6>
